...
func InitialSettings() []model.SettingItem {
	...
	initialSettingItems = []model.SettingItem{
		...
		{Key: conf.Announcement, Value: "### :P", Type: conf.TypeText, Group: model.SITE},
	...
	"mobi,azw3": {
		...
		//}`, Type: conf.TypeText, Group: model.PREVIEW},
		{Key: "audio_cover", Value: "https://cdn.jsdelivr.net/gh/NodeSeekDev/alist@main/images/logo.svg", Type: conf.TypeString, Group: model.PREVIEW},
